...
\subsection{Conduttori e dielettrici}
\begin{definition}
...
Consideriamo due armature piane di superficie $\Sigma$ e carica opposta $+q$ e $-q$ poste a una distanza $h<<\Sigma$, trascurando gli effetti di bordo si ottiene:
\begin{equation}
    E(\text{tra le armature})= \frac{\sigma}{\epsilon_0}\implies V = \frac{\sigma}{\epsilon_0}h = \frac{q}{\epsilon_0\Sigma}h 
    \implies C = \epsilon_0\frac{\Sigma}{h}
\end{equation}
